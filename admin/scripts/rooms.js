...
function add_room() {
    ...
    xhr.onload = function () {
        var
            myModal = document.getElementById('add-room');
        var
            modal = bootstrap.Modal.getInstance(myModal);
        modal.hide();
...
function rem_image(img_id, room_id) {
    ...
    xhr.onload = function () {
        if (this.responseText == 1) {
            alert('success', 'New Image Removed!', 'image-alert');
